package net.mcreator.golden.client.gui;
...
public class SharpenerguiScreen extends AbstractContainerScreen<SharpenerguiMenu> {
	private final static HashMap<String, Object> guistate = SharpenerguiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_sharpen;

	public SharpenerguiScreen(SharpenerguiMenu container, Inventory inventory, Component text) {
	...
	public void init() {
		...
		guistate.put("button:button_sharpen", button_sharpen);
		this.addRenderableWidget(button_sharpen);
	}
}
