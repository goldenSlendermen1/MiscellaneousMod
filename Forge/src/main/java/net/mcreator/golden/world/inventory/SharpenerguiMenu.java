...
package net.mcreator.golden.world.inventory;
...
public class SharpenerguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SharpenerguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 52, 22) {
			private final int slot = 0;
		}));
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 107, 22) {
